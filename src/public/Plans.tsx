    ...
    >
      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-3 sm:grid-cols-2 gap-10 px-6">
        {plans.map((plan, i) => (
          ...
          >
            {/* Header */}
            <span className="flex items-center justify-center text-center mb-2.5 p-2 bg-blue-600 rounded-lg w-10 h-10 text-white absolute top-5 right-5">
              <DollarSign />
            </span>
            ...
            {/* Rate */}
            <p className="md:text-3xl text-xl font-bold text-blue-950 mb-4">{plan.rate}</p>
