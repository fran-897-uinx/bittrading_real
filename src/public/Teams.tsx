...
export default function Team() {
  return (
    <section id="team" className="py-20 bg-white text-center overflow-hidden">
      <p className="text-black font-light mb-11">
        Note: There is no withdrawals fee
      </p>
      ...
      >
        <div className="max-w-6xl mx-auto grid md:grid-cols-3 sm:grid-cols-2 gap-8 px-6 mt-16">
